...
import com.hjzddata.modular.system.dao.MenuMapper;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements IMenuService {
    ...
    @Override
    public List<Map<String, Object>> selectMenus(String condition, String level, String column) {
        return this.baseMapper.selectMenus(condition, level, column);
    }
