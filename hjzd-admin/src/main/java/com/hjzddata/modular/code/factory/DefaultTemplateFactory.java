package com.hjzddata.modular.code.factory;


import com.hjzddata.HjzdApplication;
import com.hjzddata.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("hjzd");
        genQo.setProjectPackage(HjzdApplication.class.getPackage().getName());
