...
public class TicketController extends BaseController {
    ...
    public Object ticketSave(Ticket ticket) {
        List ticketTitleExit = ticketService.ticketTitleExit(ticket.getTitle(),ticket.getId());
        if (ticketTitleExit.isEmpty()) {
            ...
            JsonResult jsonResult = new JsonResult(201, "已存在相同工单，请更换工单标题!", ticketTitleExit);
            return jsonResult;
        }
    }
