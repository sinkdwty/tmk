...
import com.hjzddata.core.common.constant.cache.CacheKey;
...
import com.hjzddata.modular.system.dao.*;
import com.hjzddata.modular.system.model.*;
...
public class ConstantFactory implements IConstantFactory {
    ...
    private MediaMapper mediaMapper = SpringContextHolder.getBean(MediaMapper.class);
    private KnowledgeMapper knowledgeMapper = SpringContextHolder.getBean(KnowledgeMapper.class);
    ...
    public String getDeptName(Integer deptId) {
        ...
        if (ToolUtil.isNotEmpty(dept) && ToolUtil.isNotEmpty(dept.getFullname()) && ToolUtil.isNotEmpty(dept.getSimplename())) {
    ...
    public String getCategoryName(Integer category) {
        return getDictsByName("媒体分类", category);
    }
     ...
     */
    @Override
    public String getCategoryKnowledgeCategoryName(Integer category) {
        return getDictsByName("知识分类", category);
    }
     ...
     */
    @Override
    public String getCustomStatus(Integer status) {
        return getDictsByName("案件分配", status);
    }
     ...
     */
    @Override
    public String getMediaName(Integer mediaId) {
        Media media = mediaMapper.selectById(mediaId);
        if (ToolUtil.isNotEmpty(media) && ToolUtil.isNotEmpty(media.getName())) {
    ...
    public String getGoodsName(Integer goodsId) {
        ...
        if (ToolUtil.isNotEmpty(goods) && ToolUtil.isNotEmpty(goods.getGoodsName())) {
     ...
     */
    @Override
    public String getCallSystemName(Integer callSystemId) {
        return getDictsByName("外呼系统", callSystemId);
    }
    ...
    public String getProductNameById(Integer product_id) {
        ...
        if (ToolUtil.isNotEmpty(product) && ToolUtil.isNotEmpty(product.getName())) {
