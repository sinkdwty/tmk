package com.hjzddata.core.log.factory;

import com.hjzddata.core.db.Db;
import com.hjzddata.core.log.LogManager;
import com.hjzddata.core.util.ToolUtil;
import com.hjzddata.core.common.constant.state.LogSucceed;
import com.hjzddata.core.common.constant.state.LogType;
...
public class LogTaskFactory {
    ...
    public static TimerTask bussinessLog(final Integer userId, final String bussinessName, final String clazzName, final String methodName,final Integer customid ,final String msg) {
        return new TimerTask() {
            @Override
            public void run() {
                OperationLog operationLog = LogFactory.createOperationLog(
                        LogType.BUSSINESS, userId, bussinessName, clazzName, methodName,customid ,msg, LogSucceed.SUCCESS);
                try {
