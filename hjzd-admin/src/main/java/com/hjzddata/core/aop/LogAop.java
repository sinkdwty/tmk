...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.hjzddata.core.common.annotion.BussinessLog)")
    ...
    private void handle(ProceedingJoinPoint point) throws Exception {
        ...
        Integer customid =0;
        try{
            customid = Integer.parseInt(params[params.length-1].toString()) > 0 ? Integer.parseInt(params[params.length-1].toString()) : 0;
        }catch (Exception ex){
            customid = 0;
        }
        ...
        LogManager.me().executeLog(LogTaskFactory.bussinessLog(user.getId(), bussinessName, className, methodName ,customid,msg));
    }
}