...
import com.hjzddata.core.base.tips.ErrorTip;
...
public class GlobalExceptionHandler {
     ...
     * 拦截业务异常
     */
    @ExceptionHandler(HjzdException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    @ResponseBody
    public ErrorTip notFount(HjzdException e) {
    ...
    public String accountLocked(DisabledAccountException e, Model model) {
        ...
        LogManager.me().executeLog(LogTaskFactory.loginLog(username, "账号被禁用", HttpKit.getIp()));
        model.addAttribute("tips", "账号被禁用");
        return "/login.html";
    }
