...
public class DictSelectorTag extends Tag {
    ...
    public void render(){
        ...
        if(ToolUtil.isEmpty(attrs.get("code"))){
            throw new HjzdException(BizExceptionEnum.ERROR_CODE_EMPTY);
        }
        ...
        //默认select
            ...
            if(list.size()>=searchnum){
                if (width.equals("auto")) {
                    html.append("class=\"form-control chosen-select\" style=\"width:"+width+"\"  tabindex=\"1\" \r\n");
                } else {
                    html.append("class=\"form-control chosen-select\" style=\"width:"+width+"px\"  tabindex=\"1\" \r\n");
                }
            } else{
                if (width.equals("auto")) {
                    html.append("class=\"form-control\" style=\"width:"+width+"\" \r\n");
                } else {
