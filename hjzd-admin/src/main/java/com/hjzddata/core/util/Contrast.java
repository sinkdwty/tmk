...
import com.hjzddata.core.support.StrKit;
import com.hjzddata.core.common.constant.dictmap.base.AbstractDictMap;
import com.hjzddata.core.common.constant.dictmap.factory.DictFieldWarpperFactory;
import com.hjzddata.core.support.StrKit;
...
public class Contrast {
            ...
            for (Field field : fields) {
                ...
                if (!o1.toString().equals(o2.toString())) {
                    ...
                    if (fieldWarpperMethodName != null) {
                        ...
                        str += "字段名称:" + fieldName + ", " + o1Warpper + " => " + o2Warpper;
                    } else {
                        str += "字段名称:" + fieldName + ", " + o1 + " => " + o2;
                    }
                    i++;
                }
            }
     ...
     * @return
     */
    public static List<String[]> getListStrArray(String[] dd, int b) {
