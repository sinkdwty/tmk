layui.use(["element", "layedit", "form"], function () {
    ...
    form.on('submit(add)', function(data){
        ...
        $.ajax({
            url: Feng.ctxPath + '/ticket/ticket_save',
            type: 'post',
            data: data.field,
            dataType: 'json',
...
$('#selectCustomId').on('click', function () {
    ...
    layer.open({
        ...
        maxmin: true,
        shade: 0,
        content: Feng.ctxPath + "/ticket/select_custom?deptId=" + assignDeptId
    });
    return false;
});
...
$('#selectUserId').on('click', function () {
    ...
    layer.open({
        ...
        maxmin: true,
        shade: 0,
        content: Feng.ctxPath + "/ticket/select_user?deptId=" + assignDeptId
    });
    return false;
});
...
$('#selectFollows').on('click', function () {
    ...
    layer.open({
        ...
        maxmin: true,
        shade: 0,
        content: Feng.ctxPath + "/ticket/select_follows?follows=" + follows + "&deptId=" + assignDeptId
    });
    return false;
});