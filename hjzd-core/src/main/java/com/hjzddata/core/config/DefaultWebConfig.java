...
import com.hjzddata.core.base.controller.HjzdErrorView;
...
public class DefaultWebConfig extends WebMvcConfigurationSupport {
    ...
    @Bean("error")
    public HjzdErrorView error() {
        return new HjzdErrorView();
    }
    ...
    public class StringToDateConverter implements Converter<String, Date> {
        ...
        public Date convert(String dateString) {
            ...
            if (dateFlag) {
                ...
                throw new HjzdException(HjzdExceptionEnum.INVLIDE_DATE_STRING);
            }
