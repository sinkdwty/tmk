package com.hjzddata.core.config;

import com.alibaba.druid.pool.DruidDataSource;
import com.baomidou.mybatisplus.plugins.OptimisticLockerInterceptor;
import com.baomidou.mybatisplus.plugins.PaginationInterceptor;
import com.hjzddata.core.config.properties.DruidProperties;
import com.hjzddata.core.config.properties.MutiDataSourceProperties;
import com.hjzddata.core.datascope.DataScopeInterceptor;
import com.hjzddata.core.mutidatasource.DynamicDataSource;
import com.hjzddata.core.mutidatasource.aop.MultiSourceExAop;
import com.hjzddata.core.config.properties.DruidProperties;
import com.hjzddata.core.config.properties.MutiDataSourceProperties;
import com.hjzddata.core.datascope.DataScopeInterceptor;
import com.hjzddata.core.mutidatasource.DynamicDataSource;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "hjzd.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2)
@MapperScan(basePackages = {"com.hjzddata.modular.*.dao"})
