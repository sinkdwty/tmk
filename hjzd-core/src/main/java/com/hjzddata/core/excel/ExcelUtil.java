package com.hjzddata.core.excel;
...
public class ExcelUtil {
    ...
    public static <T> Collection<T> importExcel(Class<T> clazz, InputStream inputStream,
        ...
        try {
            ...
            {
                 throw new  RuntimeException(MessageFormat.format("关闭文件流",
                         clazz.getSimpleName()), e);
            }
        }
        return list;
    ...
    public static HSSFWorkbook getHSSFWorkbook(String sheetName,String []title,String [][]values, HSSFWorkbook wb){
        ...
        //调整列宽
        for(int i=0; i <= title.length; i++) {
//            sheet.autoSizeColumn(i); //调整列宽
            sheet.setColumnWidth(i, 20 * 256);//调整列宽为20个字符
        }
        return wb;
    }
}
