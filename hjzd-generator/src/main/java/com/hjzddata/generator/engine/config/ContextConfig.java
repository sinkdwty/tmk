package com.hjzddata.generator.engine.config;
...
public class ContextConfig {
    ...
    private String projectPath = "D:\\ideaSpace\\hjzd";//模板输出的项目目录
    ...
    private String proPackage = "com.hjzddata.admin";
    private String coreBasePackage = "com.hjzddata.core";
    private String modelPackageName = "com.hjzddata.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.hjzddata.modular.system.dao";    //model的dao
