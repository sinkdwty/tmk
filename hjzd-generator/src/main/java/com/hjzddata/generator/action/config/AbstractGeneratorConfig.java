...
import com.hjzddata.core.util.FileUtil;
import com.hjzddata.generator.engine.SimpleTemplateEngine;
import com.hjzddata.generator.engine.base.HjzdTemplateEngine;
import com.hjzddata.generator.engine.config.ContextConfig;
import com.hjzddata.generator.engine.config.SqlConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doHjzdGeneration() {
        HjzdTemplateEngine HjzdTemplateEngine = new SimpleTemplateEngine();
        HjzdTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        HjzdTemplateEngine.setSqlConfig(sqlConfig);
        HjzdTemplateEngine.setTableInfo(tableInfo);
        HjzdTemplateEngine.start();
    }
}
